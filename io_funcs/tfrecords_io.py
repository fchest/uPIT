...
def get_padded_batch(file_list, batch_size, input_size, output_size,
    ...
    sequence_features = {
        'input_bn': tf.FixedLenSequenceFeature(shape=[input_size/2],
                                         dtype=tf.float32),
    ...
    queue = tf.PaddingFIFOQueue(
        ...
        shapes=[(None, input_size/2), (None, input_size), (None, output_size),(1,2), ()])

    enqueue_ops = [queue.enqueue([sequence['input_bn'],
                                  sequence['inputs'],
                                  sequence['labels'],
                                  sequence['genders'],
